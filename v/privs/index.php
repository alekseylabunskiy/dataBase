                    ...
                    <tr>
                        ...
                        <td class="col-md-2">
                            <div class="form-group">
                                <select class="form-control rolesPrivsSelect" name="roles">
                                    <option hidden selected><?php echo $list['role_name']; ?></option>
                                    <?php if (isset($roles)): ?>
                                        <?php foreach ($roles as $rolesList): ?>
                                            <option
                                                value="priv_id=<?php echo $list['priv_id'] ?>&role_id=<?php echo $rolesList['role_id']; ?>"><?php echo $rolesList['role_name']; ?></option>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                                </select>
                            </div>
