<div class="row">
    <div class="col-lg-10 col-md-offset-1">
        <div class="row">
            <a href="/index.php?c=main&a=single_user&id=<?php if (isset($one_person)) {echo $one_person['user_id'];} ?>">
                <button class="btn btn-info">Редактировать</button>
            </a>
            <a href="/index.php?c=main&a=view&delete_id=<?php if (isset($one_person)) {echo $one_person['user_id'];} ?>">
